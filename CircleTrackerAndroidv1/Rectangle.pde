class Rectangle
{
  ...
  ArrayList<Rectangle> difference(Rectangle r)
  {
    ...
    if (intersection!=null)
    {
      ...
      int bottomRightY=intersection.getY();
      ...
      {
        /*fill(color(255,0,0));
        ellipse(topLeftX,topLeftY,10,10);
        fill(color(0,0,255));
        ellipse(bottomRightX,bottomRightY,10,10);
        stroke(color(0,255,0));
        line(topLeftX,topLeftY,bottomRightX,bottomRightY);
        stroke(color(0,0,0));
        
        println("top:"+topLeftX+","+topLeftY);
        println("bottom:"+bottomRightX+","+bottomRightY);
        */
        if ((!(topLeftX==this.getX()&&topLeftY==this.getY()&&bottomRightX==this.getRight()&&bottomRightY==this.getBottom()))&&(!(topLeftX==intersection.getX()&&topLeftY==intersection.getY()&&bottomRightX==intersection.getRight()&&bottomRightY==intersection.getBottom())))
        {
          ...
          if ((w>0)&&(h>0))
          {
            Rectangle newRect=new Rectangle(topLeftX,topLeftY,w,h);
            if (!difference.contains(newRect))
            {
              difference.add(new Rectangle(topLeftX,topLeftY,w,h));
            }
          }
        }
        ...
        else if (bottomRightX==this.getRight())
        {
             topLeftX=this.getX();
             ...
             else if (bottomRightY==intersection.getBottom())
             {
               bottomRightY=this.getBottom();
             }
             else if (bottomRightY==this.getBottom())
             {
               break;
             }
        }
